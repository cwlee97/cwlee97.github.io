...
# Rename README.md
before_md_name = ''
md_path = 'C:/Users/Administrator/Desktop/github/Programmers_cpp-main/'
...
for dir in dir_list:
    ...
    for i in range(len(file_names_in)):
        ...
        print(n_name)
        with open(md_path, 'a', encoding = "UTF-8") as f:
            f.write('* [{}](https://1stapplepie.github.io/programmers_cpp/{}/)\n'.format(name, n_name))
            f.close()
